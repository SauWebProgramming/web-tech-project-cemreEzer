...
const fetchMediaData = async () => {
    ...
    try {
        ...
        if (mediaListContainer) {
            mediaListContainer.innerHTML = `<div class="error-message">Veri yüklenemedi: ${error.message}</div>`;
        }
    }
};
...
const showDetails = (id) => {
    ...
    detailSection.innerHTML = `
        <div class="detail-card">
            ...
            <p><strong>Oyuncular:</strong> ${media.oyuncular ? media.oyuncular.join(', ') : 'Bilgi yok'}</p>
